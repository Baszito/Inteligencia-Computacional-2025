...
class Genotipo:
    ...
    def mutacion(self):
        ...
        if(self.aux<=self.posibilidad_mutacion):
            randi = random.randint(0, self.cant_bits)
...
class AlgEvolutivo:
    ...
    def generacion(self):
        ...
        while(True):
            ...
            if (self.progenitor2 != self.progenitor1):
                break
    ...
    def evolucion(self):
        ...
        while ((self.mejor_aptitud<self.aptitud_requerida) or (it >= self.max_iteraciones)):
...
poblacion=AlgEvolutivo(10,10,390,50)
poblacion.evolucion()